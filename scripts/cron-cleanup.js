#!/usr/bin/env node
/**
 * RelancePro Africa - Cron Job: Cleanup
 * This script is called by Render's cron service daily at 3 AM
 * Cleans up expired demo accounts and old data
 */
...
async function main() {
  ...
  try {
    ...
    // Call the stats endpoint to update daily stats
    await callCronEndpoint('/api/cron/stats');
