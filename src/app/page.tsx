...
import { TEMPLATE_VARIABLES_ARRAY } from "@/lib/templates/variables";
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-gray-950 dark:via-gray-900 dark:to-orange-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-lg shadow-orange-200 dark:shadow-orange-900/30">
            ...
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">
                Éditeur de modèles de messages
              </p>
            </div>
          </div>
          ...
          <Card className="max-w-md mx-auto">
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Créez et personnalisez vos modèles de relances pour Email et WhatsApp.
              </p>
              <Link href="/login">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {TEMPLATE_VARIABLES_ARRAY.slice(0, 6).map((v) => (
                    <Badge 
                      key={v.key} 
                      variant="secondary" 
                  ...
                  <Badge variant="outline" className="text-orange-600">
                    +{TEMPLATE_VARIABLES_ARRAY.length - 6} autres
                  </Badge>
                </div>
              </div>
            </div>
